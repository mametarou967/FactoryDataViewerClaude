...
### Step3: センサー統合（デュアルコア）
#### Step3-1: TSL2561フェーズ（実装済み・動作確認待ち）
...
- [ ] **動作確認**: Arduino IDEで書き込み → test_edge.pyで 'P' コマンドが実lux値を返すことを確認
#### Step3-2: MCP3208フェーズ（電流ユニット、未着手）
- [ ] Core1実装: MCP3208高速サンプリング（~1kHz）+ RMS計算
- [ ] Core0: C('Current')コマンド応答時に共有データを読み出して返送
